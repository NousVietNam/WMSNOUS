-- Migration: Create RPC function for Inventory Totals calculation
...
BEGIN
    ...
    -- 2. Approved Aggregates (Orders) - RESEPECT PRODUCT FILTERS, IGNORE LOCATION/BOX
    -- (Approved Demand is system-wide, currently not linked to specific location until allocated)
