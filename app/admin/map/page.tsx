...
import { Save, ZoomIn, ZoomOut, Move, Grid, Layers, Loader2, MousePointer2, Info, Box, ArrowUp, ArrowDown, Search, X as SearchX, Home } from "lucide-react"
                ...
                >
                    ...
                    {stacks.map(stack => (
                        <div
                            ...
                            className={`
                                absolute border rounded-md shadow-sm flex flex-col items-center justify-between p-1 transition-all overflow-hidden
                                ${mode === 'EDIT' ? 'bg-white border-blue-500 hover:ring-2 ring-blue-300 cursor-grab active:cursor-grabbing' : getStackColor(stack)}
