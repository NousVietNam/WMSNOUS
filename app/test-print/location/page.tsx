...
export default function LocationPrintPage() {
    const [value, setValue] = useState("A-01-01")

    return (
        <div className="p-8 space-y-8">
            <div className="max-w-md mx-auto space-y-4">
                <h1 className="text-2xl font-bold">In Vị trí (Location)</h1>
            ...
            <PrintLayout>
                <div className="flex flex-col items-center justify-center h-full w-full p-4 space-y-4">
                    ...
                    <div className="text-5xl font-mono font-bold mt-4 break-all">{value}</div>
                </div>
            </PrintLayout>
        </div>
    )
