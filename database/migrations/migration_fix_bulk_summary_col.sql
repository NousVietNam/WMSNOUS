...
-- Fix Bulk Summary RPC (get_inventory_bulk_summary)
-- Change b.warehouse_id -> l.warehouse_id
...
BEGIN
    ...
    inv_stats AS (
        ...
        WHERE 
            ...
            bi.quantity > 0 AND
            (p_warehouse_id IS NULL OR l.warehouse_id = p_warehouse_id) AND -- <== FIXED: Use Location's warehouse_id
