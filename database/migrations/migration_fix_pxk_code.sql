...
-- Update ship_outbound_order to use Order Code for PXK
...
BEGIN
    ...
    -- 2. Generate PXK Code based on Order Code
    -- Format: PXK-{OrderCode} (e.g., PXK-SO-0126-00018)
    v_pxk_code := 'PXK-' || v_order.code;
